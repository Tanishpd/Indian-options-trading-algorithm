...
| Machine learning (14 configs, walk-forward + Romano-Wolf + power analysis) | **0/14 profitable**; winner's entire edge is 1 skipped day (Romano-Wolf adj **p = 0.215**); and the sample **cannot detect a mandate-sized edge at all** (MDE ~₹31–37k vs a ~₹19k target) | [docs/19](19-ml-has-no-edge.md) |
