...
| Machine learning (14 configs, walk-forward, Romano-Wolf, cost sensitivity) | **No model beats always-trade at ANY slippage tested** (RW adj p = 0.32 / 0.21 / 0.21 at ₹0.25 / 0.50 / 0.75 per leg); winner's entire edge is 1 skipped day. NB the strategy's own profitability is a slippage bet (docs/17), not an ML result | [docs/19](19-ml-has-no-edge.md) |
